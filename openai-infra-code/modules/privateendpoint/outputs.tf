...
output "private_dns_zones_ids" {
  ...
  value       = {
    for config in azurerm_private_endpoint.private_endpoint.private_dns_zone_configs : config.name =>
    config.private_dns_zone_id
  }
}
...
output "private_dns_zones_record_sets" {
  ...
  value       = {
    for config in azurerm_private_endpoint.private_endpoint.private_dns_zone_configs : config.name =>config.record_sets
  }
}
